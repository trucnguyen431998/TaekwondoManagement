...
<meta charset="UTF-8">
    ...
    <script type="text/javascript">
        ...
        function exportClub() {
            $.ajax({
                url: '{{action("examController@getexportExam")}}',
                type: 'GET',
                dataType:'JSON',
...
<body>
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='exam'"><i class="fas fa-arrow-left"></i></button>
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='exportexam'"><i class="fas fa-undo"></i></button>
