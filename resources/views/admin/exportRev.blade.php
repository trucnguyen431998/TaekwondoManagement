...
<head>
    ...
    <script type="text/javascript">
        ...
        function exportClub() {
            $.ajax({
                url: '{{action("revenuesController@getexportRev")}}',
                type: 'GET',
                dataType:'JSON',
...
<body>
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='revenues_col'"><i class="fas fa-arrow-left"></i></button>
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='exportrev'"><i class="fas fa-undo"></i></button>
