...
<head>
    ...
    <script type="text/javascript">
        ...
        function exportClub() {
            var id= $("#id").val();
            $.ajax({
                url: '{{action("classController@getexportClass")}}',
                type: 'GET',
                data:{id:id},
                dataType:'JSON',
...
<body>
    ...
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='/projectTruc/public/class/{{$id}}'"><i class="fas fa-arrow-left"></i></button>
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='{{$id}}'"><i class="fas fa-undo"></i></button>
