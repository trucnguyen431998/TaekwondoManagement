...
<meta charset="UTF-8">
    ...
    <script type="text/javascript">
        ...
        function exportList() {
            var examID= $("#id").val();
            $.ajax({
                url: '{{action("examController@getexportExamList")}}',
                type: 'GET',
                data:{examID:examID},
                dataType:'JSON',
...
<body>
    ...
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='/projectTruc/public/exam_list/{{$examID}}'"><i class="fas fa-arrow-left"></i></button>
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='/projectTruc/public/exam_list/exportexamlist/export/{{$examID}}'"><i class="fas fa-undo"></i></button>
