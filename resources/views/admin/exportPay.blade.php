...
<head>
    ...
    <script type="text/javascript">
        ...
        function exportClub() {
            $.ajax({
                url: '{{action("payController@getexportPay")}}',
                type: 'GET',
                dataType: 'JSON',
...
<body>
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='revenues_pay'"><i class="fas fa-arrow-left"></i></button>
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='exportpay'"><i class="fas fa-undo"></i></button>
