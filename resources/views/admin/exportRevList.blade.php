...
<head>
    ...
    <script type="text/javascript">
        ...
        function exportRevList() {
            var id= $("#id").val();
            $.ajax({
                url: '{{action("revenuesController@getexportRevList")}}',
                type: 'GET',
                data:{id:id},
                dataType:'JSON',
...
<body>
    ...
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='coach'"><i class="fas fa-arrow-left"></i></button>
    <button type="button" class="btn btn-success mt-2 ml-3" onclick="location.href='exportcoach'"><i class="fas fa-undo"></i></button>
